...
export default function LeagueClient({ leagueSlug }: { leagueSlug: string }) {
  ...
  // 1. Visar ligans matcher, loggor och arenor direkt vid laddning
    ...
    return (
      <div className="min-h-screen bg-slate-50 flex flex-col justify-between">
        ...
        <div className="max-w-xl mx-auto text-center py-20 px-4">
          ...
          <p className="text-slate-600 mb-6">Vi kunde inte hitta ligan: "{leagueSlug}"</p>
      ...
      <main className="max-w-6xl mx-auto px-4 py-12">
        ...
        <section className="mb-14">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {leagueData.teams && leagueData.teams.filter(Boolean).map((slug) => {
