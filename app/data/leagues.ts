...
export const LEAGUES_DATA: Record<string, LeagueSEOData> = {
  ...
  "europa-league": {
    ...
    teams: ["lyon", "olympiakos", "bayer-leverkusen", "sunderland", "juventus", "milan", "benfica", "rennes", "rb-salzburg", "hoffenheim", "besiktas", "marseille", "crystal-palace", "real-sociedad", "bournemouth", "omonia", "celta-vigo", "ararat-armenia", "sparta-prag", "jagiellonia", "anderlecht", "celje", "az", "sturm-graz", "hapoel-sheva", "dinamo-zagreb", "levski-sofia", "ofi-kreta", "celtic", "ferencvaros", "nec", "viktoria-plzen", "union-sg", "lillestrom", "torreense", "lech-poznan"]
  }
